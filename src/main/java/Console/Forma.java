...
@WebServlet ("/shot")
public class Forma extends GenericServlet
{
	@Override
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException 
	{
		...
		if(Email1.equals(Email)&&Pass1.equals(Pass))
		{
			...
			RequestDispatcher rd=req.getRequestDispatcher("WoFile.html");
			rd.include(req, res);
		...
		else
		{
			...
			RequestDispatcher rd=req.getRequestDispatcher("LoFile.html");
